...
class Client:
    ...
    def sendRtspRequest(self, requestCode):
        ...
        try:
            ...
            print("Oops, something is wrong BOY!")
    ...
    def openRtpPort(self):
        ...
        # TCP (SOCK_STREAM) is a connection-based protocol. The connection is established and the
        # two parties have a conversation until the connection is terminated by one of the parties or by a network error.
